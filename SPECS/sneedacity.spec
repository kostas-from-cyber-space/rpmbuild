...
%global commit0 bf7cd23ef9680bc4541b2c877c17a345ca9e2b7e
%global shortcommit0 #(c=#{commit0}; echo ${c:0:7})

Name: sneedacity

Version: bf7cd23ef9680bc4541b2c877c17a345ca9e2b7e
Release: 1%{?dist}
Summary: Multitrack audio editor
License: GPLv2
URL:     https://www.sneedacity.org/

Source0: https://github.com/Sneeds-Feed-and-Seed/%{name}/archive/%{commit0}/%{name}-%{commit0}.tar.gz
...
%description
Sneedacity is a cross-platform multitrack audio editor. It allows you to
...
%package manual
Summary: Manual for Sneedacity - Offline Install
BuildArch: noarch
Requires: /usr/bin/sneedacity

%description manual
Sneedacity Manual can be installed locally if preferred, or accessed on-line
...
#
appstream-util replace-screenshots $RPM_BUILD_ROOT%{_datadir}/appdata/sneedacity.appdata.xml \
...
desktop-file-install --dir $RPM_BUILD_ROOT%{_datadir}/applications \
        $RPM_BUILD_ROOT%{_datadir}/applications/sneedacity.desktop
...
%changelog
* Thu Jul 8 2021 kostas <kostas@cocaine.ninja>
- Modified it for Sneedacity
